...
//		store.setDefault(PreferencePage.P_MAX_VIEW_RECORD, 500);
		store.setDefault(PreferencePage.P_MAX_VIEW_RECORD, 100);
	...
	private List createURL() {
		...
		// for symfoware
		list.add(new String[] {"com.fujitsu.symfoware.jdbc.RDADriver", "jdbc:symforda://<host>:2002/<database>"}); //$NON-NLS-1$ //$NON-NLS-2$
		list.add(new String[] {"com.fujitsu.symfoware.jdbc.SYMDriver", "jdbc:symford://<host>:2050/<database>"}); //$NON-NLS-1$ //$NON-NLS-2$
