...
import zigen.plugin.db.ui.views.BindingParamArea;
...
public class SQLSourceViewer extends ProjectionViewer implements ISQLOperationTarget {
	...
	protected BindingParamArea bindingParamArea;
	...
	public void setBindingParamArea(BindingParamArea area){
		this.bindingParamArea = area;
	}
	
	public BindingParamArea getBindingParamArea(){
		return this.bindingParamArea;
	}
	
	public SQLExecuteView getSQLExecuteView() {
		try {
