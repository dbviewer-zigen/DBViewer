...
public class Column extends TreeLeaf {
	...
	public String getColumnLabel() {
		return getColumnLabel(false);

	}
	public String getColumnLabel(boolean showRemark) {
		...
		if (showRemark && DbPlugin.getDefault().getPreferenceStore().getBoolean(DBTreeViewPreferencePage.P_DISPLAY_COL_COMMENT)) {
