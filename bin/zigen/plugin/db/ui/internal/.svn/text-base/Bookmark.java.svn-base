...
public class Bookmark extends TreeNode implements ITable {
	...
	public void copy(Table original) {
		...
		timestamp = original.getUpdTime() == null ? 0 : original.getUpdTime().getTime();  
	}
	...
	public void setUpdTime(Timestamp date) {
//		table.setUpdTime(date);
		this.timestamp = date.getTime();
	}
	
	public Timestamp getUpdTime() {
//		return table.getUpdTime();
